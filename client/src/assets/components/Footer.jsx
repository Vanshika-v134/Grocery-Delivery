        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">GroceryApp is your premium online grocery destination, delivering exceptional quality and convenience to your doorstep.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm">Email: support@groceryapp.com</p>
          ...
          <div className="mt-12 text-center text-sm">
            <p>&copy; 2023 GroceryApp By Sparsh Gambhir. All rights reserved.</p>
          </div>
        </div>
      </footer>
  );
